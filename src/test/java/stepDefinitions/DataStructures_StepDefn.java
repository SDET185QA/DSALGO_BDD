...
public class DataStructures_StepDefn {
	...
	public void user_clicks_on_data_structures_get_started() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("User is redirected to DataStructures - Introduction Page")
	public void user_is_redirected_to_data_structures_introduction_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("User clicks on TimeComplexiy")
	public void user_clicks_on_time_complexiy() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@Then("It should navigate to TimeComplexity Page")
	public void it_should_navigate_to_time_complexity_page() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
	...
	public void it_should_navigate_to_python_code_editor() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("User enters the valid Python Code")
	public void user_enters_the_valid_python_code(io.cucumber.datatable.DataTable dataTable) {
	    // Write code here that turns the phrase above into concrete actions
	...
	public void the_editor_should_print_the_valid_result() {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
